document.addEventListener("DOMContentLoaded", () => {
    ...
    if(true) {
        ...
        searchbars.forEach(searchbar => {
            const button = searchbar.nextElementSibling;
...
window.aigm_template.mobile_slick_breakpoint = [ { breakpoint: window.aigm_template.mobile_screen_width, settings: { slidesToShow: 1 } } ];
